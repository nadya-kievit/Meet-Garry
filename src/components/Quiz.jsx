...
function AnswerIcon({ name }) {
	return (
		<svg className="answer-icon" viewBox="0 0 24 24" aria-hidden="true">
			...
			{name === 'tree' && (
				<>
					<path d="M10 22v-6M14 22v-6M8 22h8" />
					<path d="M12 3C8.7 3 6.4 5.1 6.3 8 4.9 8.7 4 10.1 4 11.8c0 2.5 2 4.5 4.5 4.5 1 0 1.9-.3 2.6-.9.5.4 1.3.4 1.8 0 .7.6 1.6.9 2.6.9 2.5 0 4.5-2 4.5-4.5 0-1.7-.9-3.1-2.3-3.8-.1-2.9-2.4-5-5.7-5Z" />
				</>
			)}
			{name === 'deer' && (
				<>
